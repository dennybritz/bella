...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsAppJsx = __webpack_require__(215);

	var _componentsHomeJsx = __webpack_require__(216);
	...
	var routes = _react2['default'].createElement(
	  ...
	  _react2['default'].createElement(
	    _reactRouter.Route,
	    { path: '/', component: _componentsAppJsx.App },
	    _react2['default'].createElement(_reactRouter.IndexRoute, { name: 'home', component: _componentsHomeJsx.Home }),
	    _react2['default'].createElement(_reactRouter.Route, { path: '*', component: _componentsHomeJsx.Home })
	  )
	);

	_reactDom2['default'].render(routes, document.getElementById('main'));
